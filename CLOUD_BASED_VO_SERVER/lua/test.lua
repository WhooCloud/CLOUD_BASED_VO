...
local Ddata = uncompress(data, 200*1024)
ngx.log(ngx.INFO, "Ddata is: ", Ddata)

local data = close_string
local Cdata = compress(data)
local bytes, err = wb:send_binary(Cdata)
